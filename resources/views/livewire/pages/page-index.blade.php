                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                <button wire:click="toggleStatus({{ $page->id }})"
                                                        ...
                                                        wire:target="toggleStatus({{ $page->id }})"
                                                        class="text-blue-600 hover:text-blue-900 disabled:opacity-50 transition-all duration-200 relative">
                                                    <span wire:loading.remove wire:target="toggleStatus({{ $page->id }})">
                                                        {{ $page->status === 'published' ? 'Unpublish' : 'Publish' }}
                                                    </span>
                                                    <span wire:loading wire:target="toggleStatus({{ $page->id }})" class="flex items-center">
                                                ...
                                                <button wire:click="deletePage({{ $page->id }})"
                                                    ...
                                                    <span wire:loading.remove wire:target="deletePage({{ $page->id }})">
                                                        Delete
                                                    </span>
                                                    <span wire:loading wire:target="deletePage({{ $page->id }})">
                                                        Deleting...
                                                    </span>
                                                </button>
                                            </div>
