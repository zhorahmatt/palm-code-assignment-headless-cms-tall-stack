                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    @if($categoryToDeletePostsCount > 0)
                                        <p class="text-sm text-gray-500">
                                            Cannot delete the category <strong>"{{ $categoryToDeleteTitle }}"</strong> because it has {{ $categoryToDeletePostsCount }} associated {{ Str::plural('post', $categoryToDeletePostsCount) }}.
                                        </p>
                                        <p class="text-sm text-gray-500 mt-2">
                                            Please remove or reassign the posts before deleting this category.
                                        </p>
                                    @else
                                        <p class="text-sm text-gray-500">
                                            Are you sure you want to delete the category <strong>"{{ $categoryToDeleteTitle }}"</strong>? This action cannot be undone.
                                        </p>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        @if($categoryToDeletePostsCount === 0)
                            <button type="button" 
                                ...
                                <span wire:loading wire:target="deleteCategory" class="flex items-center">
                        ...
                        <button type="button" 
                            ...
                            {{ $categoryToDeletePostsCount > 0 ? 'Close' : 'Cancel' }}
                        </button>
                    </div>
                </div>
            </div>
