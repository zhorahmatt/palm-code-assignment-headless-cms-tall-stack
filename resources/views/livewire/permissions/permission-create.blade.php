                                            ...
                                            <div class="flex flex-wrap gap-1">
                                                @foreach($existingGroups as $existingGroup)
                                                    <button type="button"
                                                            ...
                                                            class="inline-flex items-center px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded hover:bg-gray-200 transition-colors">
                                                        {{ $existingGroup }}
                                                    </button>
                                                @endforeach
                                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                @if($name || $display_name)
                                    <div class="bg-blue-50 p-4 rounded-lg">
                                        <h3 class="text-lg font-medium text-blue-900 mb-2">Preview</h3>
                                        <div class="space-y-2 text-sm">
                                            @if($name)
                                                <div>
                                                    <span class="font-medium text-blue-800">System Name:</span>
                                                    <span class="text-blue-700 font-mono">{{ $name }}</span>
                                                </div>
                                            @endif
                                            @if($display_name)
                                                <div>
                                                    <span class="font-medium text-blue-800">Display Name:</span>
                                                    <span class="text-blue-700">{{ $display_name }}</span>
                                                </div>
                                            @endif
                                            @if($group)
                                                <div>
                                                    <span class="font-medium text-blue-800">Group:</span>
